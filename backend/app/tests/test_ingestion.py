...
def test_topic_endpoints(client, db):
    ...
    res = client.post(
        "/api/topics/",
        json={"name": "Database Systems", "description": "Relational Databases and SQL"},
        headers=headers
    )
...
def test_successful_upload_and_polling(client, db):
    ...
    # Upload text file
    file_content = b"This is content chunk 1. We love databases. This is content chunk 2. Sorting is cool."
