...
def main():
    ...
    parser.add_argument("--documents", action="store_true", help="Purge all documents, content chunks, and files on disk.")
    ...
    parser.add_argument("--topics", action="store_true", help="Purge all topics (cascades to all other data) and disk files.")
