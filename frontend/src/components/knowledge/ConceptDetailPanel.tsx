...
export const ConceptDetailPanel: React.FC<ConceptDetailPanelProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <h2
          style={{ fontSize: '1.2rem', fontWeight: 600, color: 'var(--text-primary)', margin: 0 }}
        >
          {conceptTitle}
        </h2>
        <button
        ...
        {isLoading ? (
          ...
          >
            <Loader2
              ...
              style={{ marginBottom: '16px', color: 'var(--accent-primary)' }}
            />
            <p>Loading concept...</p>
          </div>
        ) : error ? (
