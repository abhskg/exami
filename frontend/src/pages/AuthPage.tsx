  ...
  return (
    <div style={{
        ...
        <section style={{
          ...
          <div style={{ position: 'relative', zIndex: 10 }}>
            ...
            <ul style={{ display: 'flex', flexDirection: 'column', gap: '16px', listStyle: 'none' }}>
              <li style={{ display: 'flex', alignItems: 'center', gap: '16px', color: 'rgba(255, 255, 255, 0.9)' }}>
                <span style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              "AI Prep transformed my study sessions. I went from feeling overwhelmed to completely prepared in just two weeks."
            </p>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div>
                <p style={{ fontSize: '0.85rem', fontWeight: 700, color: '#fff', margin: 0 }}>Sarah Jenkins</p>
                <p style={{ fontSize: '0.75rem', color: 'rgba(255, 255, 255, 0.6)', margin: 0 }}>Medical Resident</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ width: '100%', maxWidth: '380px', margin: '0 auto' }}>
            ...
            <p style={{
              ...
              <a href="#" style={{ color: 'var(--accent-primary)', textDecoration: 'none' }} onClick={(e) => e.preventDefault()}>Terms of Service</a> and{' '}
              <a href="#" style={{ color: 'var(--accent-primary)', textDecoration: 'none' }} onClick={(e) => e.preventDefault()}>Privacy Policy</a>.
            </p>
          </div>
        </section>
      </main>
      ...
      <div style={{
        ...
        <p style={{ fontSize: '1rem', textTransform: 'uppercase', letterSpacing: '0.15em', fontWeight: 800 }}>Cognitive Edge Design</p>
      </div>
